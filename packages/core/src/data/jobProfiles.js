...
// Phase 2.5: AI-Generated Questions System
...
const JOB_PROFILES = [
    ...
    // ==================== PSYCHOLOGY ASSESSMENT ====================
    {
        ...
        questionFormat: "scenario-based" // Indicates questions should be situational
    },

    // ==================== GENERAL KNOWLEDGE ====================
    {
        id: "current-affairs",
        name: "Current Affairs & Global Awareness",
        category: "General",
        description: "Tests knowledge of recent global events, politics, economics, and technology",
        skills: ["Global Politics", "Economics", "Technology Trends", "Environmental Issues", "Social Developments"],
        questionTopics: ["Geopolitics", "Global Economy", "Recent Scientific Breakthroughs", "International Relations", "Cultural Shifts"],
        difficulty: "medium",
        icon: "🌍",
        color: "#2563EB",
        active: true
